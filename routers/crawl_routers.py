...
from handlers.crawl_handlers.crawl_link import crawl_data_link_handler
...
from handlers.crawl_handlers.search_data_from_url import search_data_from_url_handler
...
def crawl_text_from_url():
    return crawl_data_link_handler()
...
def search_data_from_url():
    return search_data_from_url_handler()
